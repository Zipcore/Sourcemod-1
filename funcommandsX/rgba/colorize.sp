...
public Action:Command_SmColorMe(client, args)
{
	...
	//check for random color
	if(StrEqual("red", color, false) || StrEqual("blue", color, false) || StrEqual("tomato", color, false) || StrEqual("steelblue", color, false))
	{
		colorFound = true;
		ReplyToCommand(client, "[SM] %s", "This color cannot be used");		
	}
/*	else if(StrEqual("blue", color, false))
	{
		colorFound = true;
		ReplyToCommand(client, "[SM] %s", "This color cannot be used");	
	}
	else if(StrEqual("tomato", color, false))
	{
		colorFound = true;
		ReplyToCommand(client, "[SM] %s", "This color cannot be used");	
	}
	else if(StrEqual("steelblue", color, false))
	{
		colorFound = true;
		ReplyToCommand(client, "[SM] %s", "This color cannot be used");	
	}	*/
