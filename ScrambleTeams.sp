...
{
	name = "Vote Scramble Teams JsFix",
...
public OnPluginStart()
{
	...
	g_Cvar_Limits = CreateConVar("sm_votescramble_limit", "0.55", "Percent required for successful scramble vote.")
	...
	RegConsoleCmd("scramble", Command_votescramble);
