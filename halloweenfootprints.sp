...
{
	name = "[TF2] Halloween Footprints JsFix",
	author = "Oshizu",
...
{
	RegAdminCmd("sm_footprints", FootSteps, ADMFLAG_ROOT)
	RegAdminCmd("sm_trails", FootSteps, ADMFLAG_ROOT)
	RegAdminCmd("sm_footsteps", FootSteps, ADMFLAG_ROOT)
